...
const char* ssid = "1234";  // Enter SSID here
const char* password = "876543210";  //Enter Password here
...
html += "<h1>Patient Health Monitoring System</h1>";
html += "<h3><a href='By Keerthan R Varma'>By Keerthan R Varma</a></h3>";
html += "</div>";
